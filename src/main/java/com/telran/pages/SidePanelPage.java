...
public class SidePanelPage extends BasePage {
    ...
    WebElement upLodAndDownload;

    public UpLodAndDownloadPage selectUploadDownload() {
        clickWithJSExecutor(upLodAndDownload, 0, 500);
        return new UpLodAndDownloadPage(driver);
    }
}
