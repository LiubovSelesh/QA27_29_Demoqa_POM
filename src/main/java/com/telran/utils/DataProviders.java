...
public class DataProviders {
    ...
    @DataProvider
    public Iterator<Object[]> dataUserInTextBox() throws IOException {

        BufferedReader reader = new BufferedReader(new InputStreamReader(DataProviders.class.getResourceAsStream("/dataUser.csv")));
